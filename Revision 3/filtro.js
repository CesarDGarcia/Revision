...
const li = document.getElementById("lista-de-productos") // Cambiamos el getElementByName => getelementById
const ii = document.querySelector('input'); //cambiamos el $i => ii
...
//displayProductos(productos) Esto no era necesario
...
botonDeFiltro.onclick = function() {
  ...
  const texto = ii.value; // Cambiamos el $i > ii
  console.log(texto);
